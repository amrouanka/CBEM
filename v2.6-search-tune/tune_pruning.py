...
LOG_FILE = WORKDIR / "pruning_tuning_log.jsonl"
BEST_FILE = WORKDIR / "pruning_best_params.json"
...
PARAMS = [
    Param("AspirationWindow", "aw", 50, 20, 100),
    Param("AspirationMinDepth", "awmindepth", 4, 2, 8),
    Param("ReverseFutilityMaxDepth", "rfpdepth", 3, 1, 6),
    Param("ReverseFutilityMarginPerDepth", "rfp", 150, 50, 250),
    Param("FutilityMaxDepth", "fpdepth", 3, 1, 6),
    Param("FutilityMarginPerDepth", "fp", 120, 50, 200),
    Param("QsDeltaMargin", "qsdelta", 200, 50, 350),
]
