...
public static class Evaluation
{
    ...
    private static readonly int[] PassedMg = [0, 12, 36, 18, 8, 4, 2, 0];
    private static readonly int[] PassedEg = [0, 52, 64, 46, 24, 8, 2, 0];
    ...
    [
        // Pawn — untouched (entangled with passed pawn feature)
        [
           0,   0,   0,   0,   0,   0,   0,   0,
    ...
    // Bishop
    [
         -44,  -8, -82, -50, -40, -42, -14, -28,
         -39, -11, -18, -30,  18,  29,   1, -60,
    ...
    // Rook — untouched (values look reasonable)
    [
    ...
    // Knight — untouched (EG looks reasonable)
    [
    ...
    // Queen — untouched (EG values look chess-reasonable)
    [
