...
public static class Evaluation
{
    ...
    public static int EvaluateWhitePerspective(EvalFeatures f, EvalWeights w)
    {
        ...
        mg += f.QueenlessKingCenterBalance * w.QueenlessKingCenterMg;
    ...
    public static EvalFeatures ExtractFeatures()
    {
        ...
        if (bitboards[Q] == 0 && bitboards[q] == 0)
        {
            ...
            f.QueenlessKingCenterBalance =
                KingCenterTable[wkSq] -
                KingCenterTable[bkSq];
        }
